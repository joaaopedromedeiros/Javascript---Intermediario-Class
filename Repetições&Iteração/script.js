...
do {
  ...
  --> Ordem dos parametros abaixo (variável de controle)
...
//  Aula 7  -  For  in 
  ...
  // Posso usar elle para percorrewr as propriedades dentro do objeto

  for (/*propriedade  auxiliar*/ let property in person){
  ...
  // Esse steps é acionado a cada volta, a cada iteração, a cada olhada de dados do objetos (3 iterações)

  // esta percorrendo as proproiedades a ppartir de um objeto, estou pegando oo objeto de person e estou percorrendo elas, um objeto de cada vez.
